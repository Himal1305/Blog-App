...
export default function Catagary() {
    const { blogdata, loading,taghandelar,cat,homehandlar,cathandelar } = useContext(Appcontaxt);
    return loading ? (
      ...
      <p className='my-[2px]'>All Catagary Blogs for:- <span className='font-semibold'>{cat}</span></p>
     </div>
